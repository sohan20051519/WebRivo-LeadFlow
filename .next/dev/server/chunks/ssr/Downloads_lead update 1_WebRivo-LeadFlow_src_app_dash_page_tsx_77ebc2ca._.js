...
function DashboardPage() {
    const { datasets, visibleDatasets, loading, refreshDatasets, searchTerm, deleteDataset } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lead__update__1$2f$WebRivo$2d$LeadFlow$2f$src$2f$context$2f$LeadFlowContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useLeadFlow"])();
    ...
    const filteredDatasets = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lead__update__1$2f$WebRivo$2d$LeadFlow$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        return visibleDatasets.filter((ds)=>ds.name.toLowerCase().includes(lower) || ds.headers.some((h)=>h.toLowerCase().includes(lower)));
    }, [
        visibleDatasets,
        searchTerm
    ]);
...
//# sourceMappingURL=Downloads_lead%20update%201_WebRivo-LeadFlow_src_app_dash_page_tsx_77ebc2ca._.js.map