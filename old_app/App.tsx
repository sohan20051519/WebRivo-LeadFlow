            ...
            <nav className="space-y-1 pt-4 border-t border-slate-100">
              ...
              {[
                ...
                <button
                  ...
                  className={`w-full flex items-center px-3 py-2.5 rounded-xl text-sm font-medium transition-all ${currentView === item.id ? 'bg-slate-100 text-slate-900 shadow-sm' : 'text-slate-500 hover:bg-slate-50'
                    }`}
                >
